...
class HouseRepositoryTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->date_start = '2025-08-08';
        $this->date_end = '2025-08-10';
        $this->house1 = new House(type: 'test1', beds: 2, address: 'Addr1', price: 100, free: true,date_start: $this->date_start,date_end: $this->date_end);
    ...
    public function testFindByAvailablePeriod(): void
    {
        $this->repository->save($this->house1);
        $this->repository->save($this->house2);

        $all = $this->repository->findByAvailablePeriod(new Chronos($this->date_start), new Chronos($this->date_end));
        $this->assertCount(1, $all);

        $this->assertTrue($all[0]->getFree());
    }
